        ...
        <>
            <style>{`
                *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
                ...
                .page-header{background:#fff;border-bottom:1px solid #e5e7eb;padding:18px 0;text-align:center}
                .page-header h1{font-size:18px;font-weight:600;color:#1a1a2e}
                ...
                .closing-wrap input[type="number"]{width:60px}
                ...
                .rte-invalid .tox-tinymce{border-color:#ef4444 !important}
                .field-note{display:flex;align-items:flex-start;gap:6px;font-size:12px;color:#6b7280;padding:10px 20px 10px 220px;background:#fffbeb;border-bottom:1px solid #f0f0f0}
                .field-note-icon{color:#f59e0b;flex-shrink:0;margin-top:1px}
            ...
            <div className="page-body">
                <div className="container">
                    ...
                    <form onSubmit={submit}>
                        ...
                        <div className="form-card" style={{ marginTop: 0, borderTop: 'none' }}>
                            ...
                            <div className="form-actions">
                                ...
                                <a href="/vacancies" className="btn-cancel">Отмена</a>
                            </div>
